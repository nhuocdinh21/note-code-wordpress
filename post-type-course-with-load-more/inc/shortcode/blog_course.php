<?php
// [blog_course]
function shortcode_latest_from_blog_course($atts, $content = null, $tag = '' ) {
...
while ( $recentPosts->have_posts() ) : $recentPosts->the_post();
		...
		?><div class="col <?php echo implode(' ', $col_class); ?>" <?php echo $animate;?>>
			...
			<a href="<?php the_permalink() ?>" class="plain">
				<div class="box <?php echo $classes_box; ?> box-blog-post has-hover" style="<?php if( get_field('background_color_course', get_the_ID()) ): echo 'background-color: ' . get_field('background_color_course', get_the_ID()) .';'; endif; if( get_field('background_image_course', 'option') ): echo 'background-image: url(' . get_field('background_image_course', 'option') . ');'; endif; ?>">
...
add_shortcode("blog_course", "shortcode_latest_from_blog_course");
