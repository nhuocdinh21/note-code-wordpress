...
function ux_section_new( $atts, $content = null ) {
	...
	?>
	<section class="<?php echo $classes; ?>" id="<?php echo $id; ?>">
		<div class="<?php echo $classes_bg; ?>" <?php echo $parallax; ?>>

			<?php require( get_template_directory() . '/inc/builder/shortcodes/commons/video.php' ); ?>
			...
			<?php require( get_template_directory() . '/inc/builder/shortcodes/commons/border.php' ); ?>
...
add_shortcode('background', 'ux_section_new');
add_shortcode('section_new', 'ux_section_new');
add_shortcode( 'section_inner', 'ux_section_new' );