<?php
// [blog_projects]
function shortcode_latest_from_blog_projects($atts, $content = null, $tag) {
...
while ( $recentPosts->have_posts() ) : $recentPosts->the_post();
        ...
        <div class="col <?php echo implode(' ', $col_class); ?>" <?php echo $animate;?>>
            <div class="col-inner">
            <a href="<?php the_permalink() ?>" class="plain" title="<?php echo get_the_title(); ?>">
          ...
          <?php } ?>
                    <div class="box-text <?php echo $classes_text; ?>" <?php echo get_shortcode_inline_css($css_args); ?>>
                        <div class="box-text-inner blog-post-inner">
                            ...
                            <div class="project_icon"><span></span></div>
                            <div class="wrap_info">
                                ...
                                <div class="project_tool">
                                    <div class="inner">
                                        <div class="project_info">
                                            ...
                                            <p class="project_add"><?php echo $district->name; ?>, <?php echo $city->name; ?></p>
                                        </div>
                                        <?php if((!has_post_thumbnail() && $show_date !== 'false') || $show_date == 'text') {?>
                                            <div class="project_meta"><?php echo get_the_date('d/m/Y • H:i'); ?></div>
                                        <?php } ?>
                                    </div>
                                </div>
...
add_shortcode("blog_projects", "shortcode_latest_from_blog_projects");
